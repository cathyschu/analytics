---
title: "Take-home Exercise: Spatial Analysis of Essential Services in Singapore - Laundry, Beauty & Dental Business"
author: "Cathy C."
date: "Sep 9, 2025"
...
Due to data set sizes, we will analyse spatial patterns by quarter for all 3 Services. Different spatial point pattern testing menthods are used to analyse the 3 business types: G-function for Dental Services, L-function for Beauty Services, and F-function for Laundry Services.
...
tm_shape(biz_9601_sf) +
  tm_dots(col = "orange", size = 0.3, alpha = 0.9) +
