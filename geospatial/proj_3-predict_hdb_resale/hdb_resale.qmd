...
geocode <- function(block, streetname) {
  ...
  query <- list("searchVal" = address,
                ...
                "pageNum" = "1") 
  res <- GET(base_url, query = query, timeout(30)) #get URL query
  if (status_code(res) != 200) {
    message(paste("API Error:", status_code(res), "for", address))
...
for(i in 1:nrow(HDBresale)){
  ...
  if(i %% 1000 == 0) message(paste("Processed", i, "rows"))  # Progress indicator
}
```
